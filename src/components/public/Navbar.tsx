        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            <a href="/" onClick={(e) => handleNavClick(e, '/')} className="group flex items-center gap-3">
              <div className="w-10 h-10 rounded-full border border-blue-500/50 overflow-hidden shadow-[0_0_12px_rgba(37,99,235,0.2)] bg-transparent group-hover:border-blue-400 transition-all">
              ...
              <div className="flex flex-col">
                <span className="text-md md:text-xl font-black tracking-tight text-white group-hover:text-blue-400 transition-colors leading-none whitespace-nowrap uppercase">{profile?.name || "S M Hasinur Rahman"}</span>
              </div>
            </a>
          </div>
        ...
        <div className="md:hidden bg-slate-950/98 backdrop-blur-xl border-b border-white/10 absolute top-full left-0 right-0 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="px-6 py-8 space-y-6">
            ...
            <div className="flex items-center gap-4 pb-6 border-b border-white/5">
              <div className="w-14 h-14 rounded-full border-2 border-blue-500/50 overflow-hidden shadow-lg bg-transparent">
